...
CONSTS = list(
  ...
  app_version = "1.0.0",
  sidebar_title = "",
  sidebar_desc = "Cette application interactive permet d’analyser l’accessibilité aux gares, les accidents de vélo et les loyers dans le département de l’Ain en les reliant à des variables socio-démographiques telles que la densité de population.",
